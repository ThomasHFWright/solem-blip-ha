...
def test_irrigation_program_write_mismatches_verifies_period_start_date():
    ...
    assert protocol.irrigation_program_write_mismatches(written, expected) == {"period_start_date": (date(2026,6,24), date(2026,6,1))}
